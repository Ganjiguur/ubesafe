...
<div class="uk-container">
    <?= $this->Html->link('<i class="uk-icon-plus"></i> ' . __('Add New'), ['action' => 'add'], ['class' => 'uk-button  uk-button-primary uk-float-right uk-text-bold text-uppercase', 'escape' => false]) ?>
    <h1 class="text-condensed text-uppercase text-bold uk-margin-remove">
        <?= __('<%= $singularVar %>') . __('Information') ?>
    </h1>
</div>
